...
namespace WpfApp1
{
    public partial class Animation : UserControl
    {
        ...
        public void Initiate(int idleFrames, string idleFileName, int attack1Frames, string attack1FileName, double speed)
        {
        ...
        {
            if (imgIdle != null && imgAttack1 != null)  // must ensure the lists are instantiated
            {
